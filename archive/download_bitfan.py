    ...
    try:
        ...
        try:
            ...
            episode_title = wait.until(
                EC.presence_of_element_located(
                    (By.CSS_SELECTOR, "h1.p-clubArticle__name")
                )
            ).text
            artist_name = program_name
            cover_image_url = wait.until(
                EC.presence_of_element_located(
                    (By.CSS_SELECTOR, "div.p-clubArticle__thumb img")
                )
            ).get_attribute("src")
            ...
            program_name, episode_title, artist_name, cover_image_url = (
                "Unknown Program",
                "Unknown Episode",
                "Unknown Artist",
                None,
        ...
        sound_iframe = wait.until(
            EC.presence_of_element_located((By.CLASS_NAME, "sound-content"))
        )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="bitfan.jpから音声ファイルをダウンロードします。"
    )
